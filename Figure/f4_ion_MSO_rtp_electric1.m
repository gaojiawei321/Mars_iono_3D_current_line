...
method='linear';
Para=fillmissing(Para,method);
Peder=fillmissing(Peder,method);
Hall=fillmissing(Hall,method);
...
print('-dtiff','-r300',['/Users/gaojiawei/Desktop/Baiducloud/work/current/tu/Paper_tu/F4_Ion_MSO_E1.tiff']);
print('-depsc','-r300',['/Users/gaojiawei/Desktop/Baiducloud/work/current/tu/Paper_tu/F4_Ion_MSO_E1.eps']);
...
print('-dtiff','-r300',['/Users/gaojiawei/Desktop/Baiducloud/work/current/tu/Paper_tu/F4_Ion_MSO_C1.tiff']);
print('-depsc','-r300',['/Users/gaojiawei/Desktop/Baiducloud/work/current/tu/Paper_tu/F4_Ion_MSO_C1.eps']);
